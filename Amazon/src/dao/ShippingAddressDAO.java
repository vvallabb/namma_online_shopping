...
public class ShippingAddressDAO {
    ...
    public ArrayList RetrieveUserDetailsDAO(String userName)
    {
        ...
        try {
                PreparedStatement ps = c.prepareStatement("SELECT USER_DETAILS_ID, "
                ...
                ps.setString(1, userName);
                  ResultSet rs = ps.executeQuery();
                    while(rs.next())
                    {
                        ...
                        ud.setUserDetailsAddressLine1(rs.getString("USER_ID_ADDRESS_LINE1"));
                        ud.setUserDetailsAddressLine2 (rs.getString("USER_ID_ADDRESS_LINE2"));
                        ...
                        ud.setUserDetailsPhoneNumber(rs.getString("USER_ID_PHONE_NUMBER"));
            ...
            String userDetailsZip, String userDetailsCountry, String UserDetailsPhoneNumber)
    {
        ...
        Connection c = cs.initiateCon();
        try {
                PreparedStatement ps = c.prepareStatement("INSERT INTO AMAZON.USER_DETAILS  "
                +  " ( "
                + " USER_DETAILS_ID, "
                + "USER_ID_FIRST_NAME, USER_ID_MIDDLE_NAME, USER_ID_SURNAME,  "
                + "USER_ID_ADDRESS_LINE1, USER_ID_ADDRESS_LINE2, USER_ID_CITY "

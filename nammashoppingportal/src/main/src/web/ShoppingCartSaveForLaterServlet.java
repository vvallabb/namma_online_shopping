...
public class ShoppingCartSaveForLaterServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		if (deleteflag != 1) {
			updateShoppingCartState = ShopCart.UpdateShoppingCartSaveForLater(
					itemId, status, (String) session.getAttribute("uname"));
			if (!updateShoppingCartState) {
				RequestDispatcher rd = request
						.getRequestDispatcher("ShoppingCartHome.jsp");
			...
			boolean deleteShoppingCartItemState = ShopCart
